...
public class Admin_create_new_user extends javax.swing.JFrame {

    Connection conn;
    Statement s;
    

    public Admin_create_new_user() {
        initComponents();
    ...
    public Admin_create_new_user(String x){
    ...
    initComponents();
        ...
        if(Uid==null){
            ...
            jlblTopic.setText("ADD NEW USER");
    ...
    private void initComponents() {
        ...
        btnSubmit.setIcon(new javax.swing.ImageIcon(getClass().getResource("/bank/images/Done-icon.png"))); // NOI18N
        btnSubmit.setText("Submite");
        ...
        btnClear.setIcon(new javax.swing.ImageIcon(getClass().getResource("/bank/images/Actions-edit-clear-list-icon.png"))); // NOI18N
        ...
        jlblTopic.setBackground(new java.awt.Color(255, 255, 255));
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addGap(343, 343, 343)
                .addComponent(jlblTopic, javax.swing.GroupLayout.PREFERRED_SIZE, 199, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addGap(21, 21, 21)
                .addComponent(jlblTopic)
                .addContainerGap(22, Short.MAX_VALUE))
        );

        btnUpdate.setBackground(new java.awt.Color(204, 255, 204));
        btnUpdate.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        btnUpdate.setIcon(new javax.swing.ImageIcon(getClass().getResource("/bank/images/Apps-system-software-update-icon.png"))); // NOI18N
        ...
        btnDelete.setIcon(new javax.swing.ImageIcon(getClass().getResource("/bank/images/Actions-dialog-delete-icon.png"))); // NOI18N
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        int UnicL = Unic.length();
        int UcontactL = Ucontact.length();
        ...
        if(U_id.equals("")){
            ...
            JOptionPane.showMessageDialog(null, "Add A Nic Number");
        }
        else if(UnicL<10){
            JOptionPane.showMessageDialog(null, "Must Fill 10 Digit in NIC");
        }
        else if(UcontactL<10){
            JOptionPane.showMessageDialog(null, "Must Fill 10 Digit in Contact No");
        }
        else{

        String Sql = "INSERT INTO `users`(`user_id`, `user_name`, `password`, `user_type`, `full_name`, `tel`, `nic`, `address`) VALUES ( '" + U_id + "','" + Uname + "' ,'" + Upwd + "','" + Utype + "','" + Ufname + "','" + Ucontact + "','" + Unic + "','" + Uaddress + "') ";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_create_new_user.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Admin_create_new_user().setVisible(true);
            }
        });
    }
